...
public class TesteComCinco {
    public static void main(String[] args){
        ...
        try(FileWriter fW = new FileWriter("tempo_que_levou_para_fim_da_exec_utlizando5Threads.txt")){
            fW.write("Tempo total de execução = " + tempoDeExecucao + "milissegundos utilizando 5 threads");
            System.out.println("Foi salvo no arquivo o tempo de execução " + tempoDeExecucao + "milissegundos utilizando 5 thread");
        }catch (IOException g){
